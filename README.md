...
Разработка ядра приложения: Спроектировал и реализовал финансовое ядро приложения для управления кошельками с полным циклом операций: создание кошельков, пополнение, списание средств и отображение баланса.

- **Архитектура API:** Разработал надежное и безопасное RESTful API на Django REST Framework для выполнения финансовых операций и управления данными.
- **Безопасность и целостность данных:** Реализовал механизмы обеспечения целостности финансовых операций и предотвращения race condition при одновременных обращениях к балансу.
- **Производственная инфраструктура:** Настроил production-окружение с использованием Docker и docker-compose, обеспечив контейнеризацию приложения и простоту развертывания.
- **DevOps:** Интегрировал CI/CD через GitHub Actions для автоматизации тестирования.
